class UsuariosController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @usuario.update(usuario_params)
        format.html { redirect_to @usuario, notice: "Usuario ha sido Actualizado." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to usuarios_path, status: :see_other, notice: "Usuario ha sido Eliminado." }
